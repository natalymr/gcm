...
from code2seq_dataset.info_classes import DatasetPart
...
if __name__ == '__main__':
    filtered_diff_dir: Path = Path('../../../new_data/processed_data/filtered_diffs')
    output_parent_dir: Path = Path('../../../new_data/processed_data/nematus_data')
