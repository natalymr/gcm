...
NullFunctionInfo = FunctionInfo("Empty", "0" * 40,  [])
...
def collect_changed_functions(blob_positions: List[Tuple[int, int]],
    ...
    for start, len in blob_positions:
        ...
        if other_function:
            ...
            full_removed_functions.add((function, NullFunctionInfo))
...
def compare_two_blobs(blob_positions: List[Tuple[int, int]],
    ...
    changed_functions, deleted_functions = collect_changed_functions(blob_positions, other_blob_positions, data_file)
    _, added_functions = collect_changed_functions(other_blob_positions, blob_positions, data_file)
...
def remove_method_name_with_commit_message_and_split_dataset(data: str,
    ...
    total_commits = len(splitted_dataset['train']) + len(splitted_dataset['test']) + len(splitted_dataset['val'])
...
def main():
    global lasts_blobs
    train_data_path = "/Users/natalia.murycheva/Documents/code2seq/aurora.correct.train.raw.txt"
    test_data_path = "/Users/natalia.murycheva/Documents/code2seq/aurora.correct.test.raw.txt"
    val_data_path = "/Users/natalia.murycheva/Documents/code2seq/aurora.correct.val.raw.txt"
    ...
    full_log, lasts_blobs = parse_full_log(full_log_file)

    # for data in [train_data_path, test_data_path, val_data_path]:
    splitted_commits = f"{dataset_name}_splitted_commits_set_train_val_test.pickle"
